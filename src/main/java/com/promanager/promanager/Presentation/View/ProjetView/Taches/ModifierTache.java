...
public class ModifierTache extends AnchorPane {
    ...
    private Stage stage;
    private ModifierTacheController controller;
    ...
    public ModifierTache(ObjectId id,ObjectId idTache,Stage stage) {
        ...
        this.stage = stage;
        this.controller = new ModifierTacheController(this,id,idTache,stage);
        this.design();
    }
