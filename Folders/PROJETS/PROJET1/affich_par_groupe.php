...
<style>
    ...
    <form action="affich_par_groupe.php" method="post">
        <div class="info">
        <Label for="NG">Numéro Groupe</Label>
        <input type="text" name="NG" required><br><br>
...
<?php  
    ...
    $req=mysqli_query($conne,"SELECT * FROM eleve,appartenir,solde
                     where eleve.id_eleve=appartenir.id_eleve 
                     and eleve.id_eleve=solde.id_eleve
                     and appartenir.id_groupe='$gr'
