...
<body>
    ...
    $req=mysqli_query($conne,"SELECT DISTINCT s.time_séance,s.jour_séance ,s.sale_séance,s.id_groupe,
                    g.nom_matiere,g.Niveau_Scolaire FROM enseignant e,séance s,groupe g
                    where e.id_enseignant=s.id_enseignant
                    and g.id_groupe=s.id_groupe
                    and e.prenom_enseignant='$pr' 
                    and e.nom_enseignant='$nm'
                    ");
