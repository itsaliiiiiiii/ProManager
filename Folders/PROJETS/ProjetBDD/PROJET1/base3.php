...
<body>
    ...
    <section class="main">
        ...
        <form action="base3_next.php" class="form" method="post">
            <?php 
            ...
            $id=$li['id_eleve'];
            $_SESSION['id_eleve_soft'] = $id;
            $mati=$_POST['language'];
            $_SESSION['languages']=$mati;
            ...
            if($check==0){
                $CR=mysqli_query($conne,"INSERT INTO `groupe` (`id_groupe`, `status_groupe`, `nom_matiere`, `Niveau_Scolaire`) VALUES (NULL, 'NON ACTIF', '$mati', 'NULL')");
