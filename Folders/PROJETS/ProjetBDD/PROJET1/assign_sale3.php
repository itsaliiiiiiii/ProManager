...
<body>
    ...
    if (mysqli_num_rows($req) < 6)
    {
        ...
        $req2 = mysqli_query($conne, "SELECT * from enseignant where type_formation='Informatique'");
        $li=mysqli_fetch_array($req2);
        $ens=$li['id_enseignant'];
        $grp=$_SESSION['id_gr_soft'];
    ...
    else
    {
        ...
        ?><a href="check_status3.php">Go to this link </a>
    <?php }
     ?>
</body>
</html>