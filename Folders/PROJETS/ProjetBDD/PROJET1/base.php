...
<body>
    ...
    <section class="main">
        ...
        <form action="base_next.php" class="form" method="post">
            ...
            $type_formation="Soutien Scolaire";
            ...
            and groupe.Niveau_Scolaire='$niveau'");
            $check=0;
            ...
            if($check==0){
                $CR=mysqli_query($conne,"INSERT INTO `groupe` (`id_groupe`, `status_groupe`, `nom_matiere`, `Niveau_Scolaire`) VALUES (NULL, 'NON ACTIF', '$mati', '$niveau')");
                $req4=mysqli_query($conne,"SELECT id_groupe FROM groupe where nom_matiere='$mati' and Niveau_Scolaire='$niveau' and id_groupe NOT IN (select id_groupe from appartenir)");
