...
public class AjouterDocumentSeancesProjet extends AnchorPane {
    ...
    private AjouterDocumentSeancesProjetController controller;

    public AjouterDocumentSeancesProjet(Stage stage, ObjectId idSeance, ObjectId idProjet) {
        ...
        Document = new Text("");
        controller = new AjouterDocumentSeancesProjetController(this,idSeance, idProjet,stage);
        design();
    }
