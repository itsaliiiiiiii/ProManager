...
public class AjouterDocumentTachePage extends AnchorPane {
    ...
    private AjouterDocumentTachePageController controller;

    public AjouterDocumentTachePage(Stage stage, ObjectId idTache) {
        ...
        Document = new Text("");
        controller = new AjouterDocumentTachePageController(this, idTache, stage);
        design();
    }
