...
import com.promanager.promanager.Presentation.Controller.ProjetController.Taches.ModifierTacheController;
...
public class ModifierTacheListe extends AnchorPane {
    ...
    private Stage stage;
    private ModifierTacheListeController controller;
    ...
    public ModifierTacheListe(ObjectId idTache,Stage stage) {
        ...
        this.stage = stage;
        this.controller = new ModifierTacheListeController(this,idTache,stage);
        this.design();
    }
    ...
    private void design() {
        ...
        getChildren().addAll(AjouterProjet, Categorie,
