...
public class AffichageTacheHistorique extends AnchorPane {
    ...
    private AffichageTacheHistoriqueController controller;
    ...
    public AffichageTacheHistorique(ObjectId idTache, ObjectId idProjet, Stage stage) {
        ...
        this.controller = new AffichageTacheHistoriqueController(this, stage, idTache, idProjet);
        design();
    }
