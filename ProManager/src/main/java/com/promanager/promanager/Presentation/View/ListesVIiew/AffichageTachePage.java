...
import com.promanager.promanager.Presentation.Controller.ListesController.AffichageTachePageController;
...
public class AffichageTachePage extends AnchorPane {
    ...
    private AffichageTachePageController controller;
    ...
    public AffichageTachePage(ObjectId idTache, Stage stage) {
        ...
        this.controller = new AffichageTachePageController(this, stage, idTache);
