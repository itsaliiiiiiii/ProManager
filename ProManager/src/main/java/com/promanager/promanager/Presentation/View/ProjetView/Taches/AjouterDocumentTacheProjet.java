...
public class AjouterDocumentTacheProjet extends AnchorPane {
    ...
    private AjouterDocumentTacheProjetController controller;

    public AjouterDocumentTacheProjet(Stage stage, ObjectId idTache, ObjectId idProjet) {
        ...
        Document = new Text("");
        controller = new AjouterDocumentTacheProjetController(this,idTache, idProjet,stage);
        design();
    }
